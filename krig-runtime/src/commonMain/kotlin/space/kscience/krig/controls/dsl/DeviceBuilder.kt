...
public interface DeviceReadScope : DeviceEnvironment {
    ...
    public suspend fun <T> read(spec: DevicePropertySpec<*, T>): T
...
public interface DeviceWriteScope : DeviceReadScope {
    ...
    public suspend fun <T> write(spec: MutableDevicePropertySpec<*, T>, value: T)
...
public interface DeviceActionScope : DeviceWriteScope {
    ...
    public suspend fun <I, O> execute(spec: DeviceActionSpec<*, I, O>, input: I): O?
}
