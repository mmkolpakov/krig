 ...
 *
 * **Sampling**: [sampler] is opt-in. Drivers that natively publish into a slot (e.g. Modbus
 * polling loop, EPICS monitor callback) implement it for zero-allocation streaming;
...
public interface TypedDevice {
    ...
    public fun <I, O> action(spec: DeviceActionSpec<*, I, O>): TypedAction<I, O> =
