...
/**
 * Portable descriptor for a device contract.
 *
 ...
 * `DeviceActionContract`; executable bindings stay in backends. Transport layers should project
 * this contract model to explicit DTOs.
 */
