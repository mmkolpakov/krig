...
public class BackendBuilder internal constructor() {
    ...
    private var batchReadBody: (suspend (Collection<PropertyDescriptor>) -> Map<Name, OperationOutcome<Meta>>)? = null
     ...
     */
    public fun batchReader(body: suspend (Collection<PropertyDescriptor>) -> Map<Name, OperationOutcome<Meta>>) {
...
private class BuiltTypedBackend(
    ...
    private val batchReadBody: (suspend (Collection<PropertyDescriptor>) -> Map<Name, OperationOutcome<Meta>>)?,
    ...
    context(device: DeviceEnvironment)
    override suspend fun readBatch(properties: Collection<PropertyDescriptor>): Map<Name, OperationOutcome<Meta>> {
