...
public interface BinaryPeerConnection : AutoCloseable {
    ...
    public suspend fun receive(contentId: String, requestMeta: Meta? = null): ByteArray?

    /** Ship [payload] tagged with [contentId] for later recall. */
    public suspend fun send(contentId: String, payload: ByteArray, requestMeta: Meta? = null)
