...
public fun ReplayLog(messages: Flow<DeviceMessage>): ReplayLog =
 ...
 */
@OptIn(InternalKrigApi::class)
public fun Device.replayLog(): ReplayLog = ReplayLog(messageFlow.payloads())

/**
 * **Digital-twin role marker.** A state object whose state is a pure fold of replayed messages:
