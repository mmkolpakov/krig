 ...
 * The underlying primitives ([SnapshotStore], [space.kscience.krig.storage.journal.EventJournal],
 * [CheckpointStrategy], [runCheckpointing]) are stable; only the assembly shape may still evolve.
 */
@RequiresOptIn(
